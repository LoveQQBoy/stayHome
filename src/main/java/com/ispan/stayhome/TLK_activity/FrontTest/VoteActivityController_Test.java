...
@Controller
public class VoteActivityController_Test {

	@Autowired
	private VoteActivityService voteActivityService;
	
	//進入投票前台頁面
	@GetMapping("/vote/voteFrontPage_TLK")
	public String visitVoteFrontPage(
		...
		return "vote/showVoteActivityFront_TLK";
	}
	
	//進入投票後台頁面
	@GetMapping("/vote/voteBackPage_TLK")
	public String visitVoteBackPage(@RequestParam(name="page",defaultValue="1")Integer pageNumber,Model model,
		...
		return "vote/showVoteActivityBack_TLK";
	}
	
	//進入新增投票頁面
	@GetMapping("/vote/createVotePage_TLK")
	public String visitCreateVotePage() {
		return "vote/createVoteActivity_TLK";
	}

	// 進入修改投票頁面
	@GetMapping("/vote/editVotePage_TLK")
	public String visiteditPage(@RequestParam Integer id, Model model) {
		...
		return "vote/editVoteActivity_TLK";
	}

	// 新增投票活動
	@PostMapping("/vote/createVote_TLK")
	public String addVoteActivity(@RequestParam("title") String title, @RequestParam("context") String context,
		...
		return "redirect:/vote/voteBackPage_TLK";
	}

	// 更新投票活動
	@PutMapping("/vote/editVote_TLK")
	...
	// 刪除投票活動
	@DeleteMapping("/vote/deleteVote_TLK")
	...
	// 進入投票頁面
	@GetMapping("/vote/doVotePage_TLK")
	public String visitDoVotePage(@RequestParam(name="voteid")Integer voteId, Model model) {
		...
		return "vote/doVoteActivity_TLK";
	}
	
	//進行投票並新增記錄
	@PostMapping("/vote/addVoteRecord_TLK")
	public String addDoVoteRecord(@RequestParam(name="voteid")Integer voteId,
		...
		return "redirect:/vote/voteFrontPage_TLK";
	}
	
	//進入投票活動詳細頁面
	@GetMapping("/vote/voteDetailPage_TLK")
	public String visitVoteDetailPage(@RequestParam(name="voteid")Integer voteId, Model model) {
		...
		return "vote/showVoteActivityDetail_TLK";
	}
}
